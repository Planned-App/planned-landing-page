...
const AutoPlayVideoComponent: React.FC<AutoPlayVideoProps> = ({
  src,
  poster
}) => {
  ...
  return (
    <div
      className={`relative w-full  h-[${videoHeight}px]`}
      style={
        isMobile
          ? {
              width: "auto",
      ...
      {!hasPlayed && isIntersecting && (
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <button
            ...
            className="bg-[#1E4D38] text-white rounded-lg px-4 py-2 text-lg font-bold"
          >
            Play Video
          </button>
        </div>
