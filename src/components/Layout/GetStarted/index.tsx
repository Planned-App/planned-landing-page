            ...
            <div className="bg-white border-4 border-[#1E4D38] px-6 py-6 md:px-16 md:pb-10 md:pt-16 rounded-lg w-full max-w-4xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10 md:mt-0">
                    ...
                    >
                        ...
                        <p className="text-sm text-[#1E4D38]">$69 billed annually (Saves $75 per year!), cancel anytime.</p>
                    </div>
                ...
                <div className="mt-6 mb-2">
                    <p className="font-poppins text-xl italic font-normal">🎉 Plus our Limited Time Bonus: Get access to our premium breakfast, lunch, snack & seasonal cookbook recipes ($70 value)—FREE with any plan!</p>
                </div>
                ...
                <p className="text-[1rem] italic font-normal text-center mt-4">Easily cancel through the app anytime. No commitments.</p>
            </div>
        </section>
    );
};
